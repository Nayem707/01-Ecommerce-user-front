...
const ProductsView = () => {
  ...
  return (
    <div className='col-span-2 flex '>
      <div className='w-60 hidden md:flex h-screen '>
        <Filter1 />
      </div>
      ...
      <div className='w-full pt-10 px-4 divide-y-2 divide-zinc-700'>
        ...
        {/* Card Example */}
        <div className='mx-auto max-w-2xl md:px-4 py-16 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8'>
          <div className='grid grid-cols-2 md:gap-x-6 gap-y-10 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8'>
