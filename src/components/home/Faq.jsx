...
const Faq = () => {
  ...
  return (
    <div className=' 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4 mt-10'>
      ...
      <div className=' flex md:flex-row flex-col md:space-x-8 md:mt-10'>
        <div className=' md:w-52/12 lg:w-4/12 w-full '>
          <img
            src='https://storage.googleapis.com/wp-stateless-myfbaprep/2023/01/2.01-MyFBAPrep-1200x628-AMM-124782-scaled.jpg'
